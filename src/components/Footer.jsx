        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-3xl font-semibold mb-1">{t.companyName}</h3>
            ...
            <div className="flex space-x-4 border-l-4 border-cyan-300 pl-6 py-3">
              <a
                href="#"
                className="group relative p-2 bg-white/10 rounded-full hover:bg-white/20 transition-all duration-300"
              >
          ...
          <div className="relative">
            ...
            <ul className="space-y-3">
              {[
                ...
                {
                  href: "/blog",
                  text: language === "vi" ? "Blog & Tin tức" : "Blog & News",
                },
                {
                  href: "/contact",
                  text: language === "vi" ? "Liên hệ" : "Contact",
                },
              ].map((link, index) => (
                <li key={index}>
                  <a
                  ...
                  >
                    <svg
                      className="w-4 h-4 mr-3 text-cyan-300 transform group-hover:translate-x-1 transition-transform duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              <div className="flex">
                <input
                  type="email"
                  placeholder={
                    language === "vi" ? "Email của bạn" : "Your email"
                  }
