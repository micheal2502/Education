              ...
              <div className="space-y-10">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-10 shadow-xl flex flex-col justify-center">
                  <div className="inline-flex items-center mb-8">
                    <svg
                      className="w-10 h-10 text-[#0974B6] mr-4"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="group bg-white rounded-2xl shadow-xl overflow-hidden h-[750px] hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="p-10 flex flex-col h-[354px]">
                    ...
                    <h3 className="text-3xl manrope-bold text-gray-900 mb-6 leading-tight">
                      {language === "vie"
                        ? "Bí quyết thành công của học sinh quốc tế"
                        : "The Success Secrets of International Students"}
                    </h3>
                ...
                <div className="group bg-white rounded-2xl shadow-xl overflow-hidden h-[750px] hover:shadow-2xl transition-all duration-500">
                  <div className="h-96 overflow-hidden">
                    <img
                      ...
                      alt={
                        language === "vie" ? "Hướng nghiệp" : "Career guidance"
                      }
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                    />
                  </div>
                  <div className="p-10 flex flex-col h-[354px]">
                    <div className="flex items-center text-lg text-gray-500 mb-6">
                      ...
                      <span>
                        {language === "vie" ? "10/03/2024" : "Mar 10, 2024"}
                      </span>
                      <span className="mx-3">•</span>
                      <span>
                        {language === "vie" ? "8 phút đọc" : "8 min read"}
                      </span>
                    </div>
                    <h3 className="text-3xl manrope-bold text-gray-900 mb-6 leading-tight">
                      {language === "vie"
                        ? "Định hướng nghề nghiệp trong kỷ nguyên số"
                        : "Career Guidance in the Digital Era"}
                    </h3>
                    <p className="text-gray-600 manrope-regular text-lg leading-relaxed mb-8 line-clamp-4">
                      {language === "vie"
              ...
              <div className="space-y-10">
                ...
                <div className="group bg-white rounded-2xl shadow-2xl overflow-hidden h-[750px] hover:shadow-3xl transition-all duration-500">
                  ...
                  <div className="p-10 flex flex-col h-[354px]">
                    <h3 className="text-3xl manrope-bold text-gray-900 mb-6 leading-tight">
                      {language === "vie"
                        ? "Phát triển tư duy lãnh đạo thế hệ mới"
                        : "Developing Next-Generation Leadership Thinking"}
                    </h3>
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700 manrope-medium">
                          {language === "vie"
                            ? "Kỹ năng giao tiếp đa văn hóa và đa thế hệ"
                            : "Cross-cultural and multi-generational communication skills"}
                        </span>
                      </div>
                    </div>
                ...
                <div className="group bg-white rounded-2xl shadow-xl overflow-hidden h-[750px] hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="p-10 flex flex-col h-[354px]">
                    <div className="flex items-center text-lg text-gray-500 mb-6">
                      ...
                      <span className="mx-3">•</span>
                      <span>
                        {language === "vi" ? "10 phút đọc" : "10 min read"}
                      </span>
                    </div>
                    <h3 className="text-3xl manrope-bold text-gray-900 mb-6 leading-tight">
                      {language === "vie"
                        ? "Hành trang du học: Từ A đến Z"
                        : "Study Abroad Essentials: From A to Z"}
                    </h3>
                    <p className="text-gray-600 manrope-regular text-lg leading-relaxed mb-8 line-clamp-4">
                      {language === "vie"
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center mr-4">
                          <span className="text-purple-700 manrope-bold">
                            S
                          </span>
                        </div>
                        <span className="text-gray-700 manrope-medium">
                ...
                <div className="group bg-white rounded-2xl shadow-xl overflow-hidden h-[750px] hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="p-10 flex flex-col h-[354px]">
                    <div className="flex items-center text-lg text-gray-500 mb-6">
                      ...
                      <span>
                        {language === "vie" ? "28/02/2024" : "Feb 28, 2024"}
                      </span>
                      <span className="mx-3">•</span>
                      <span>
                        {language === "vie" ? "7 phút đọc" : "7 min read"}
                      </span>
                    </div>
                    <h3 className="text-3xl manrope-bold text-gray-900 mb-6 leading-tight">
                      {language === "vie"
