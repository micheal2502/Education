        ...
        for (let x = 0; x < canvas.width; x++) {
          const y =
            ...
            Math.sin(x * wave.frequency + time * wave.speed + index) *
              wave.amplitude +
            Math.sin(x * wave.frequency * 0.7 + time * wave.speed * 1.3) *
              (wave.amplitude * 0.5);
          ...
          <div className="content-overlay">
            ...
            <div className="description-container">
              <p className="description">
                Immersive learning programs designed to{" "}
                <span className="highlight">ignite creativity</span>,
                <span className="highlight"> nurture deep thinking</span>, and{" "}
                <span className="highlight">build lasting connections</span>{" "}
                like waves of wisdom flowing through an inspiring learning
                space.
              </p>
            </div>
      ...
      <section className="carousel-section">
        <div className="carousel-header">
          ...
          <p className="carousel-subtitle">
            Explore our immersive programs and educational journeys
          </p>
        </div>
                  ...
                  <div className="card-image-wrapper">
                    ...
                    <div className="card-overlay">
                      <span className="experience-number">
                        Experience {(index % images.length) + 1}
                      </span>
                    </div>
                  </div>
                  <div className="card-content">
                    <h4 className="card-title">
                      Learning Program {(index % images.length) + 1}
                    </h4>
                    <p className="card-description">
                      Immersive educational experience designed for
