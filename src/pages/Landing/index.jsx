  ...
  return (
    <div className="min-h-screen bg-[#0974B6] flex flex-col items-center justify-center text-white p-4 overflow-hidden relative">
          ...
          >
            ...
            >
              ...
              {section === 3 && (
                <>
                  <div
                    className={`absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-white/30 transition-all duration-1500 ease-out ${sectionsVisible ? "opacity-100" : "opacity-0"}`}
                  ></div>
                  <div
                    className={`absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-cyan-300/30 transition-all duration-1500 ease-out ${sectionsVisible ? "opacity-100" : "opacity-0"}`}
                  ></div>
                  <div
                    className={`absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-blue-300/30 transition-all duration-1500 ease-out ${sectionsVisible ? "opacity-100" : "opacity-0"}`}
                  ></div>
                  <div
                    className={`absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-cyan-300/30 transition-all duration-1500 ease-out ${sectionsVisible ? "opacity-100" : "opacity-0"}`}
                  ></div>
                </>
              )}
            </div>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className={`absolute top-16 left-16 w-10 h-10 transition-all duration-2000 ease-out ${sectionsVisible ? "opacity-40" : "opacity-0"}`}
        >
        ...
        <div
          className={`absolute top-16 right-16 w-10 h-10 transition-all duration-2000 ease-out delay-200 ${sectionsVisible ? "opacity-40" : "opacity-0"}`}
        >
        ...
        <div
          className={`absolute bottom-16 left-16 w-10 h-10 transition-all duration-2000 ease-out delay-400 ${sectionsVisible ? "opacity-40" : "opacity-0"}`}
        >
        ...
        <div
          className={`absolute bottom-16 right-16 w-10 h-10 transition-all duration-2000 ease-out delay-600 ${sectionsVisible ? "opacity-40" : "opacity-0"}`}
        >
          <div className="w-full h-full border border-cyan-300/20 rotate-45"></div>
          <div className="absolute inset-3 border border-cyan-300/10 rotate-45"></div>
        </div>
        ...
        <div
          className={`absolute top-1/4 left-1/4 transition-all duration-3000 ease-in-out ${centerLogoVisible ? "opacity-25" : "opacity-0"}`}
        >
        ...
        <div
          className={`absolute bottom-1/4 right-1/4 transition-all duration-3000 ease-in-out delay-1000 ${centerLogoVisible ? "opacity-20" : "opacity-0"}`}
        >
      ...
      <div className="relative z-20 w-full max-w-6xl mx-auto px-4 md:px-8 flex flex-col items-center justify-center">
          ...
          <div className="w-full md:w-1/2 flex justify-center mb-6 sm:mb-8 md:mb-0 md:pr-6 lg:pr-12">
            ...
            >
              <div className="relative w-full aspect-square">
                ...
                <div
                  className={`absolute -inset-4 sm:-inset-6 md:-inset-8 border-2 border-white/20 rounded-full transition-all duration-2000 ease-out delay-300 ${centerLogoVisible ? "opacity-40" : "opacity-0"}`}
                ></div>
                <div
                  className={`absolute -inset-6 sm:-inset-8 md:-inset-10 border border-cyan-300/25 rounded-full transition-all duration-2500 ease-out delay-500 ${centerLogoVisible ? "opacity-30" : "opacity-0"}`}
                ></div>
                ...
                <div
                  className={`absolute -top-3 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gradient-to-br from-blue-300/50 to-transparent rotate-45 transition-all duration-2000 ease-out delay-700 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
                ></div>
                <div
                  className={`absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gradient-to-tr from-cyan-300/50 to-transparent rotate-45 transition-all duration-2000 ease-out delay-800 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
                ></div>
                <div
                  className={`absolute top-1/2 -left-3 transform -translate-y-1/2 w-4 h-4 bg-gradient-to-br from-cyan-300/50 to-transparent rotate-45 transition-all duration-2000 ease-out delay-900 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
                ></div>
                <div
                  className={`absolute top-1/2 -right-3 transform -translate-y-1/2 w-4 h-4 bg-gradient-to-bl from-blue-300/50 to-transparent rotate-45 transition-all duration-2000 ease-out delay-1000 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
                ></div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative mx-8">
            <div className="text-3xl text-blue-300/70 font-light animate-pulse-slow">
              ✦
            </div>
            <div className="absolute inset-0 text-3xl text-white/30 blur-sm animate-pulse">
              ✦
            </div>
            <div className="absolute inset-2 text-2xl text-cyan-300/30 blur animate-pulse-slower">
              ✦
            </div>
          </div>
      ...
      <div
        className={`absolute top-8 left-8 w-24 h-24 border-t-2 border-l-2 border-blue-300/40 transition-all duration-1500 ease-out z-20 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
      >
        <div
          className={`absolute -top-1.5 -left-1.5 w-3 h-3 bg-gradient-to-br from-blue-300/70 to-transparent rotate-45 transition-all duration-2000 ease-out ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
        ></div>
      </div>

      <div
        className={`absolute top-8 right-8 w-24 h-24 border-t-2 border-r-2 border-cyan-300/40 transition-all duration-1500 ease-out z-20 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
      >
        <div
          className={`absolute -top-1.5 -right-1.5 w-3 h-3 bg-gradient-to-bl from-cyan-300/70 to-transparent rotate-45 transition-all duration-2000 ease-out delay-200 ${centerLogoVisible ? "opacity-100" : "opacity-0"}`}
        ></div>
      </div>

      <div
        className={`absolute bottom-8 left-8 w-24 h-24 border-b-2 border-l-2 border-blue-300/40 transition-all duration-1500 ease-out z-20 ${rightTextVisible ? "opacity-100" : "opacity-0"}`}
      >
        <div
          className={`absolute -bottom-1.5 -left-1.5 w-3 h-3 bg-gradient-to-tr from-blue-300/70 to-transparent rotate-45 transition-all duration-2000 ease-out delay-400 ${rightTextVisible ? "opacity-100" : "opacity-0"}`}
        ></div>
      </div>

      <div
        className={`absolute bottom-8 right-8 w-24 h-24 border-b-2 border-r-2 border-cyan-300/40 transition-all duration-1500 ease-out z-20 ${rightTextVisible ? "opacity-100" : "opacity-0"}`}
      >
        <div
          className={`absolute -bottom-1.5 -right-1.5 w-3 h-3 bg-gradient-to-tl from-cyan-300/70 to-transparent rotate-45 transition-all duration-2000 ease-out delay-600 ${rightTextVisible ? "opacity-100" : "opacity-0"}`}
        ></div>
      </div>
